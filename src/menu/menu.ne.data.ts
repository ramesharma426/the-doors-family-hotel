    ...
    blocks: [
      {
        ...
        title: 'सट',
        items: [
          { name: 'J&auml;germeister', price: '४५०' },
          { name: 'J&auml;gerbomb', price: '६००' },
      ...
      },
      {
        ...
        title: 'वाइन',
        items: [
          { name: 'Big Master <small>(रेड / ह्वाइट)</small>', price: '१,४००' },
          { name: 'J.P. Chenet <small>(R / W)</small>', price: '३,१००' },
          { name: 'Robertson', price: '२,६००' },
        ],
      },
      {
        type: 'category',
        title: 'बियर',
        items: [
          { name: 'Gorkha', price: '४७५' },
          { name: 'Tuborg', price: '५७५' },
          { name: 'Barahsinghe Pilsner', price: '५७५' },
          { name: 'Barahsinghe Hazy', price: '६००' },
          { name: 'Barahsinghe Draught <small>(Pilsner) प्रति 🍺</small>', price: '४००' },
          { name: 'Carlsberg', price: '६७५' },
        ],
      },
      {
        type: 'table',
        ...
        rows: [
          { label: '8848', values: ['१४५', '२९०', '४३५', '८५०', '१,७००', '३,४००'] },
          { label: 'Absolut Vodka', values: ['३३५', '६७०', '१,०००', '२,०००', '४,०००', '१०,००० (१L)'] },
        ],
      },
      {
        type: 'table',
        ...
        columns: ['ब्रान्ड', '३० ml', '६० ml', '९० ml', '१८० ml', 'आधा', 'पूरा'],
        rows: [
          { label: 'Old Durbar', values: ['१७५', '३५०', '५२५', '१,०५०', '२,१००', '४,२००'] },
          { label: 'Old Durbar Black', values: ['२००', '४००', '६००', '१,२००', '२,४००', '४,८००'] },
          { label: 'Himalayan Reserve', values: ['२००', '४००', '६००', '१,२००', '२,४००', '४,८००'] },
          { label: 'Jack Daniel&rsquo;s', values: ['४००', '८००', '१,१९०', '२,३७५', '४,७५०', '९,५००'] },
          { label: 'Black Label', values: ['४२५', '८५०', '१,२५०', '२,५००', '५,०००', '१०,०००'] },
          { label: 'Double Black Label', values: ['४८५', '९७०', '१,४५०', '२,९००', '५,८००', '१४,५००'] },
        ],
      },
    ],
  },
